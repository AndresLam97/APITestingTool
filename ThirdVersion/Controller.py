...
class Controller():
    def __init__(self,gui):
        ...
        self.fileExtension = {
            "postmanCollection": r"*.postman_collection.json", 
            "postmanEnvironment": r"*.postman_environment.json", 
            "csv": r"*.csv",
            "json": r"*.json",
            "excel": r"*.xlsx",
            "marcoExcel": r"*.xlsm"}
    ...
    def main_frame_add_collection(self):
        fileNames = tkDialog.askopenfilenames(title = "Select Postman Collections File"
                                                      ,filetypes=[("Postman Collection File",self.fileExtension['postmanCollection'])])
    ...
    def main_frame_add_environment(self):
        fileNames = tkDialog.askopenfilenames(title = "Select Postman Environment Files"
                                                      ,filetypes=[("Postman Collection File",self.fileExtension['postmanEnvironment'])])
        for file in fileNames:
    ...
    def main_frame_add_data_file(self):
        fileTypes = [
            ...
            ("Json file",self.fileExtension['json']),
            ("Excel file",self.fileExtension['excel']),
