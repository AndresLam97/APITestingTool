...
class GUI():
    ...
    def run_process(self):
        # progressbar = ProgressBar.ProgressBar(self.tk)
        # progressbar.animated_run()
        messageDialog = MessageDialog.MessageDialog(self);
        messageDialog.display_message_dialog("Error", "Test Title", "1234567890123456789012345678901234567890123456789012345678901234567890")
